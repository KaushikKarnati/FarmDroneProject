...
public class RootLayoutController<group> {
    ...
    @FXML
    private RadioButton toggleButtonGroup1;
    @FXML
    ...
    private void initialize() {
        ...
        ItemContainer barn = new ItemContainer("Barn", 1000, 50, 395, 200, 100, 50);
        Item cow = new Item("Cow", 1000, 50, 480, 35, 30, 20, 1000, 1000);
        Item commandcenter = new Item("command center", 1000, 0, 0, 75, 120, 60, 1000, 1000);

        farm.addComp(commandcenter);
        barn.addComp(cow);
        farm.addComp(barn);
        ...
        TreeItem<Component> commandcenterNode = new TreeItem<>(commandcenter);
